export interface paths {
	...
	"api/current-node.json": {
		...
		/** Get the org-node at point in the active Emacs window */
		get: {
			parameters: {
				query?: never;
				header?: never;
			...
			requestBody?: never;
			responses: {
				/** @description Current node ID (may be null) */
				200: {
					headers: {
						[name: string]: unknown;
					};
					content: {
						"application/json": components["schemas"]["CurrentNode"];
					};
				};
			};
		};
